function createOePanelShopProductPayloads(normalizers) {
  ...
  function createShopProductPayload(body = {}) {
    ...
    const purchaseMethods = normalizePurchaseMethodsInput(body.purchaseMethods);
    ...
    if (quantity === null) return { error: 'Quantity must be a whole number.' };
    if (trackStock === null) return { error: 'Track stock must be yes or no.' };
  ...
  function createShopProductUpdatePayload(body = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(body, 'description')) {
      ...
      set['identity.shortDescription'] = String(body.description || '').trim();
    }
