...
const errorMafiaCount = document.getElementById('error-mafia-count');
const errorMafiaNone = document.getElementById('error-mafia-none');
...
function UpdateRoleCount() {
    ...
    if (!errorNotEnoughPlayers.classList.contains('active')) {
        if (mafiaCount > mafiaCountMax) {
            errorMafiaCount.classList.add('active')
        }
        else {
            errorMafiaCount.classList.remove('active')
        }

        if (mafiaCount == 0) {
            errorMafiaNone.classList.add('active')
        }
        else {
            errorMafiaNone.classList.remove('active')
        }
    }
}
